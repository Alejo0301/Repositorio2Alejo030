...
# predict the target from all the input features
       ...
       st.write("Developed By: Alejandro Gutierrez")
       st.markdown("""Reach out to me on:
       [Linkedin](linkedin.com/in/gionny-alejandro-gutierrez-piratoa-7a5a1024a) |
       """)
...
st.markdown("Please find GitHub repository link of project: ")          
